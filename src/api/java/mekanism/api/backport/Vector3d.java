...
public class Vector3d implements IPosition {
    ...
    public static Vector3d copyCenteredWithVerticalOffset(Vector3i p_237490_0_, double p_237490_1_) {
        return new Vector3d((double)p_237490_0_.getX() + 0.5D, (double)p_237490_0_.getY() + p_237490_1_, (double)p_237490_0_.getZ() + 0.5D);
    }

    public static Vector3d copyCenteredWithVerticalOffset(BlockPos p_237490_0_, double p_237490_1_) {
        return new Vector3d((double)p_237490_0_.getX() + 0.5D, (double)p_237490_0_.getY() + p_237490_1_, (double)p_237490_0_.getZ() + 0.5D);
    }
    ...
    public Vector3d(net.minecraft.client.renderer.Vector3d v) {
        this.x = v.x;
        this.y = v.y;
        this.z = v.z;
    }
