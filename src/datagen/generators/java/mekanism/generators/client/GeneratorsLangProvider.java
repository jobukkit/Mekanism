...
public class GeneratorsLangProvider extends BaseLanguageProvider {
    ...
    private void addMisc() {
        ...
        //Fission Reactor
        add(GeneratorsLang.DESCRIPTION_FISSION_REACTOR_CASING, "Brass-infused steel casing used to create a Fission Reactor. Mostly heat-resistant, mostly radiation-resistant, and mostly safe!");
